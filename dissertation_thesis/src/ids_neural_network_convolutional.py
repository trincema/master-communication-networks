...
class ConvolutionalNeuralNetworksModel(IntrusionDetectionSystem):
...
model = ConvolutionalNeuralNetworksModel(dataProcessing.data_train)
...
model.save_trained_model(model.cnn_model, 'convolutional_model')