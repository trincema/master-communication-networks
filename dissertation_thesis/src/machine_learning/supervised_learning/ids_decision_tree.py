...
class DecisionTreeClass(IntrusionDetectionSystem):
    def __init__(self) -> None:
        super().__init__()
        print("=== Decision Tree Classifier ===")
        self.classifier = DecisionTreeClassifier(criterion ="entropy", max_depth = 4)
    ...
    def train(self, data_train, labels_train):
        ...
        print("Train score for Decision Tree is:", self.classifier.score(data_train, labels_train))
    ...
    def test(self, data_test, labels_test):
        ...
        print("Test score for Decision Tree is:", self.classifier.score(data_test, labels_test))
        return predictions
...
classifier.save_trained_classifier(classifier.classifier, 'decision_tree_classifier')