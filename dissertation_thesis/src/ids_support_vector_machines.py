...
class SupportVectorMachinesClassifier(IntrusionDetectionSystem):
    def __init__(self) -> None:
        super().__init__()
        print("=== Support Vector Machines Classifier ===")
        self.classifier = SVC(gamma = 'scale')
    ...
    def train(self, data_train, labels_train):
        ...
        print("Train score for Support Vector Machines is:", self.classifier.score(data_train, labels_train))
    ...
    def test(self, data_test, labels_test):
        ...
        print("Test score for Support Vector Machines is:", self.classifier.score(data_test, labels_test))
        return predictions
...
classifier = SupportVectorMachinesClassifier()
...
classifier.save_trained_classifier(classifier.classifier, 'support_vector_classifier')